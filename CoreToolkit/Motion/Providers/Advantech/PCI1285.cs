...
namespace CoreToolkit.Motion.Providers.Advantech
{
    ...
    /// 支持轴组、插补、PTP、PVT功能
    /// </summary>
    public class PCI1285 : IMotionCard
    {
        ...
        private DEV_LIST[] _availableDevices;  // 保存可用设备列表
        ...
        // 插补缓冲区
        private Dictionary<int, InterpolationBuffer> _interpBuffers;

        // PTP和PVT规划器
        private Dictionary<int, PTPPlanner> _ptpPlanners;
        private Dictionary<int, PVTPlanner> _pvtPlanners;
        ...
        /// 控制卡名称
        /// </summary>
        public string CardName { get { return "PCI-1285"; } }
        ...
        /// 型号
        /// </summary>
        public string Model { get { return "PCI-1285"; } }
        ...
        public PCI1285()
        {
            ...
            _interpBuffers = new Dictionary<int, InterpolationBuffer>();
            _ptpPlanners = new Dictionary<int, PTPPlanner>();
            _pvtPlanners = new Dictionary<int, PVTPlanner>();
