...
namespace CoreToolkit.Tests
{
    class Program
    {
        ...
        {
            Console.WriteLine("=================================================");
            Console.WriteLine("    CoreToolkit 测试程序");
            Console.WriteLine("=================================================");
            Console.WriteLine();
            ...
            switch (choice)
            {
                case "3":
                    ...
                    break;
                case "2":
                    await RunPCI1285TestAsync();
                    break;
                case "1":
                default:
                    await RunDatabaseTestAsync();
                    break;
            }
        }
        ...
        /// 运行PCI-1285运动控制卡测试
        /// </summary>
        static async Task RunPCI1285TestAsync()
        {
            var test = new PCI1285Test();
        ...
        /// 运行轴组/插补/PTP/PVT测试
        /// </summary>
        static async Task RunAxisGroupTestAsync()
        {
            var test = new AxisGroupTest();
            await test.RunAllTestsAsync();
        ...
        /// 运行SQLite数据库测试
        /// </summary>
        static async Task RunDatabaseTestAsync()
        {
            try
            {
