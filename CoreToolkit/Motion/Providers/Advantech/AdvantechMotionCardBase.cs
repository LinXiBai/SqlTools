...
namespace CoreToolkit.Motion.Providers.Advantech
{
    /// <summary>
    /// 研华运动控制卡抽象基类
    /// 提供所有研华卡的通用实现，子类只需定义轴数和特殊功能
    /// </summary>
    public abstract class AdvantechMotionCardBase : IMotionCard
    {
        #region 字段

        private readonly object _lockObj = new object();
        private bool _disposed = false;
        protected MotionConfig _config;
        protected string _lastError = "";
        protected IntPtr _deviceHandle = IntPtr.Zero;
        protected IntPtr[] _axisHandles;
        protected DEV_LIST[] _availableDevices;

        // 轴数量（由子类在构造函数中设置）
        protected int _axisCount;

        // 轴状态缓存
        protected double[] _currentPositions;
        protected bool[] _servoStates;
        ...
        /// 厂商名称
        /// </summary>
        public virtual string Vendor { get { return "Advantech"; } }
        ...
        protected AdvantechMotionCardBase(int axisCount)
        {
